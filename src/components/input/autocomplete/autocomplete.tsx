...
const Autocomplete: React.FC<AutocompleteProps> = ({
  ...
  const onKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (filteredSuggestions.length === 0) return; // Evitar interações de teclado sem sugestões

    if (e.key === "Enter") {
      e.preventDefault(); // Impedir o comportamento padrão do Enter no formulário
      ...
      e.preventDefault(); // Impedir o scrolling da página
